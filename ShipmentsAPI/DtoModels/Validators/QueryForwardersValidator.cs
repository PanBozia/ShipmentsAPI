...
{
    public class QueryForwardersValidator:AbstractValidator<QueryForwarders>
    {
        private int[] allowedPageSizes = new[] { 5, 10, 15, 20 };
        private string[] allowedColumnNames = new[]
        {
            nameof(Forwarder.FirstName),
            nameof(Forwarder.LastName),
            nameof(Forwarder.CarPlates),
            nameof(Forwarder.Speditor),
            nameof(Forwarder.PhoneNumber)
        };
        public QueryForwardersValidator()
        {
